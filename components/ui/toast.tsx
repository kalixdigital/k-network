...
export function ToastContainer() {
  ...
  return createPortal(
    <div className="fixed top-3 left-1/2 -translate-x-1/2 z-50 flex flex-col gap-2 w-[calc(100%-24px)] max-w-md sm:top-4 sm:right-4 sm:left-auto sm:translate-x-0 sm:w-full pointer-events-none">
...
function Toast({ message, type = "info", onClose }: ToastProps & { onClose: () => void }) {
  ...
  return (
    ...
    >
      <div className={`rounded-lg border ${getStyles()} text-white p-3 sm:p-4 shadow-lg flex items-start gap-2 sm:gap-3`}>
